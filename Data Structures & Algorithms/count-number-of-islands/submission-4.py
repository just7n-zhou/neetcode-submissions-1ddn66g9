class Solution:
    def numIslands(self, grid: List[List[str]]) -> int:
        ...
        # keep BFS it's neighbor to find the entire island
        def bfs(x, y):
